# 记忆片段 Implementation Plan

> **For Claude:** REQUIRED SUB-SKILL: Use superpowers:executing-plans to implement this plan task-by-task.

**Goal:** 新增“记忆片段”主菜单与独立知识片段页面，支持 Markdown、自由标签、历史记录、假删除、右侧多文档 Tab，以及 `FTS5 + sqlite-vec` 驱动的关键词检索、自然语言检索和混合检索。
...
**Files:**
- Create: `internal/app/dtool/database/2026/03/20260306.记忆片段.sql`
...
```bash
git add internal/app/dtool/database/2026/03/20260306.记忆片段.sql internal/app/dtool/common/db.go
